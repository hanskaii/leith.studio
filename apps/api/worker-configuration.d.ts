/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 21258e773592d879c4a9053099044716)
// Runtime types generated with workerd@1.20260409.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChatAgent" | "MediaContainer" | "StudioAgent";
	}
	interface Env {
		...
		DODO_LICENSE_PRODUCT_ID: string;
		VIO_API_KEY: string;
		"chat-agent": DurableObjectNamespace<import("./src/index").ChatAgent>;
		MEDIA_CONTAINER: DurableObjectNamespace<import("./src/index").MediaContainer>;
		STUDIO_AGENT: DurableObjectNamespace<import("./src/index").StudioAgent>;
		VIDEO_PROCESSING_WORKFLOW: Workflow<Parameters<import("./src/index").VideoProcessingWorkflow['run']>[0]['payload']>;
		VIO_IMAGE_WORKFLOW: Workflow<Parameters<import("./src/index").VioImageWorkflow['run']>[0]['payload']>;
		VIO_VIDEO_WORKFLOW: Workflow<Parameters<import("./src/index").VioVideoWorkflow['run']>[0]['payload']>;
		VIO_UPSCALE_WORKFLOW: Workflow<Parameters<import("./src/index").VioUpscaleWorkflow['run']>[0]['payload']>;
		VIO_MOTION_CONTROL_WORKFLOW: Workflow<Parameters<import("./src/index").VioMotionControlWorkflow['run']>[0]['payload']>;
		STUDIO_APPROVE_WORKFLOW: Workflow<Parameters<import("./src/index").StudioApproveWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_URL" | "R2_BUCKET_NAME" | "R2_ACCOUNT_ID" | "APP_NAME" | "APP_URL" | "APP_ENV" | "APP_SECRET" | "CORS_ORIGIN" | "REMOTION_ENPOINT" | "WORKER_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "POLAR_ACCESS_TOKEN" | "POLAR_WEBHOOK_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "RESEND_FROM_EMAIL" | "SESSION_DOMAIN" | "R2_BUCKET" | "R2_ENDPOINT" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "DODO_PAYMENTS_API_KEY" | "DODO_PAYMENTS_WEBHOOK_SECRET" | "DODO_LICENSE_PRODUCT_ID" | "VIO_API_KEY">> {}
}
